...
class SirstDataset(Data.Dataset):
    def __init__(self, mode='train', crop_size=256, base_size=256, root=None):
        base_dir = root or ('C:\\Users\\mmusagezer\\Desktop\\MDVSFA-MASTER\\MDVSFA-MASTER\\sirst' if sys.platform=='win32' else './sirst')
        ...
        self.transform = transforms.Compose([
            ...
            transforms.Normalize([0.5], [0.5]),   # mean/std with length 1
        ])
